...
from it. Wired to the **flowdotcom** brand — `name: "flowdotcom"`, Romanian product
tagline/description, `themeColor: #04070f` (the dark hero backdrop the page opens on).
...
- `src/app/sitemap.ts` → `/sitemap.xml` — lists public routes (`/`, `/servicii`,
  `/colaborare`; add an entry per route as the site grows).
